...
async def _(event):
    ...
    packname = f"@luffy_fcb v0.1"
    packshortname = f"nazi_kun_{userid}"  # format: Uni_Borg_userid
    ...
    await event.edit("جاري السرقه . اصبر..!")
    ...
    await event.edit(f"تمت السرقه  [pack](t.me/addstickers/{packshortname})")
